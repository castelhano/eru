    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classificacao', models.CharField(blank=True, choices=[('RD', 'Radial'), ('DM', '<span i18n="route.metrics.transverse">Diametral</span>'), ('CR', 'Circular'), ('TR', '<span i18n="route.metrics.trunk">Troncal</span>'), ('AL', '<span i18n="route.metrics.feeder">Alimentadora</span>'), ('IT', '<span i18n="route.metrics.intersectoral">Intersetorial</span>'), ('ES', '<span i18n="route.metrics.special">Especial</span>')], max_length=3)),
