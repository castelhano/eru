...
class LocalidadeForm(forms.ModelForm):
    ...
    nome = forms.CharField(min_length=3, widget=forms.TextInput(attrs={'class': 'form-control','autofocus':'autofocus','placeholder':' '}))
...
class LinhaForm(forms.ModelForm):
    ...
    codigo = forms.CharField(max_length=8,widget=forms.TextInput(attrs={'class': 'form-control fw-bold','placeholder':' '}))
    nome = forms.CharField(min_length=3, widget=forms.TextInput(attrs={'class': 'form-control','placeholder':' '}))
    ...
    detalhe = forms.CharField(required=False, widget=forms.Textarea(attrs={'class': 'form-control','placeholder':'Detalhes', 'rows':4, 'data-i18n': '[placeholder]common.detail__plural'}))
...
class PassageiroForm(forms.ModelForm):
    ...
    referencia = forms.DateField(initial=date.today(), widget=forms.TextInput(attrs={'class':'form-control','type':'date'}))