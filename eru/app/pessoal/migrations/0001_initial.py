    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inicia_em', models.CharField(choices=[('0', 'Domingo'), ('1', 'Segunda'), ('2', 'Terça'), ('3', 'Quarta'), ('4', 'Quinta'), ('5', 'Sexta'), ('6', 'Sábado')], default='0', max_length=1, verbose_name='Inicia em')),
            ],
        ),
        migrations.CreateModel(
            name='Contrato',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filial', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='core.filial', verbose_name='Filial')),
            ],
        ),
        migrations.AddField(
            model_name='cargo',
