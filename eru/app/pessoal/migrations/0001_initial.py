    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carga_diaria', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Carga Diária')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('CF', 'Consolidação de Frequência'), ('FF', 'Fechamento de Frequência'), ('FP', 'Folha de Pagamento'), ('FH', 'Fechamento de Folha'), ('PF', 'Pagamento de Folha'), ('XF', 'Cancelamento de Folha'), ('CE', 'Carga de Escala')], max_length=2, verbose_name='Tipo')),
